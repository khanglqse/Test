...
import Breadcrumb from "../../components/landing-page/contact-us/breadcrumb.vue";
...
export default {
    ...
    methods: {
        ...
        validationForm() {
            return !this.contact.name || !this.contact.phone || !this.contact.subject || !this.contact.message;
        },
        validEmail() {
