  ...
  <div>
            ...
            <div class="">
              <div class="item">
                ...
                <div class="jp_tittle_slides_one jp_tittle_slides_two">
                  <div class="jp_tittle_side_img_wrapper">
                    <img
                      src="~/assets/css/images/content/tittle_img2.png"
                      alt="tittle_img"
                    />
                  </div>
                  <div class="jp_tittle_side_cont_wrapper">
                ...
                <div class="jp_tittle_slides_one jp_tittle_slides_third">
                  <div class="jp_tittle_side_img_wrapper">
                    <img
                      src="~/assets/css/images/content/tittle_img3.png"
                      alt="tittle_img"
                    />
                  </div>
                  <div class="jp_tittle_side_cont_wrapper">
            ...
            <div class="row">
                    ...
                    <div class="carousel theme flex">
                      <div class="item flex-1">
                        <div class="jp_hiring_content_main_wrapper">
                          <div class="jp_hiring_content_wrapper">
                            <img
                              src="~/assets/css/images/content/hiring_img1.png"
                              alt="hiring_img"
                            />
                            <h4>Akshay INC.</h4>
                            <p>(NewYork)</p>
                      ...
                      <div class="item flex-1">
                        <div class="jp_hiring_content_main_wrapper">
                          <div class="jp_hiring_content_wrapper">
                            <img
                              src="~/assets/css/images/content/hiring_img3.png"
                              alt="hiring_img"
                            />
                            <h4>Akshay INC.</h4>
                            <p>(NewYork)</p>
                      ...
                      <div class="item flex-1">
                        <div class="jp_hiring_content_main_wrapper">
                          <div class="jp_hiring_content_wrapper">
                            <img
                              src="~/assets/css/images/content/hiring_img4.png"
                              alt="hiring_img"
                            />
                            <h4>Akshay INC.</h4>
                            <p>(NewYork)</p>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="cc_featured_product_main_wrapper">
                  <div
                    class="
                      jp_hiring_heading_wrapper jp_job_post_heading_wrapper
                    "
                  >
                    <h2>Recent Jobs</h2>
                  </div>
                  ...
                  >
                            ...
                            <div class="jp_job_post_main_wrapper">
                              <div class="row">
                                ...
                                >
                                  <div class="jp_job_post_side_img">
                                    <img
                                      src="~/assets/css/images/content/job_post_img2.jpg"
                                      alt="post_img"
                                    />
                                  </div>
                                  <div class="jp_job_post_right_cont">
                            ...
                            <div class="jp_job_post_main_wrapper">
                              <div class="row">
                                ...
                                >
                                  <div class="jp_job_post_side_img">
                                    <img
                                      src="~/assets/css/images/content/job_post_img3.jpg"
                                      alt="post_img"
                                    />
                                  </div>
                                  <div class="jp_job_post_right_cont">
                            ...
                            <div class="jp_job_post_main_wrapper">
                              <div class="row">
                                ...
                                >
                                  <div class="jp_job_post_side_img">
                                    <img
                                      src="~/assets/css/images/content/job_post_img4.jpg"
                                      alt="post_img"
                                    />
                                  </div>
                                  <div class="jp_job_post_right_cont">
                            ...
                            <div class="jp_job_post_main_wrapper">
                              <div class="row">
                                ...
                                >
                                  <div class="jp_job_post_side_img">
                                    <img
                                      src="~/assets/css/images/content/job_post_img5.jpg"
                                      alt="post_img"
                                    />
                                  </div>
                                  <div class="jp_job_post_right_cont">
                    ...
                    <div class="video_nav_img_wrapper">
                      <div class="video_nav_img">
                        <ul>
                          <li>
                            <a class="button secondary url ~/assets/css/images/_nav" href="#zero"
                              >1</a
                            >
                          </li>
                          <li>
                            <a class="button secondary url ~/assets/css/images/_nav" href="#one"
                              >2</a
                            >
                          </li>
                          <li>
                            <a
                              class="button secondary url ~/assets/css/images/_nav active"
                              href="#two"
                              >3</a
                            >
                          </li>
                ...
                <div class="jp_register_section_main_wrapper">
                  <div class="jp_regis_left_side_box_wrapper">
                    <div class="jp_regis_left_side_box">
                      ...
                      <p>
                        Signed in companies are able to post new<br />
                        job offers, searching for candidate...
                      </p>
                      <ul>
                        <li>
                          <a href="#"
                            ><i class="fa fa-plus-circle"></i> &nbsp;REGISTER AS
                            COMPANY</a
                          >
                        </li>
                      </ul>
                      ...
                      <div class="carousel theme">
                        <div class="item">
                          <div class="jp_spotlight_slider_img_Wrapper">
                            <img
                              src="~/assets/css/images/content/spotlight_img.jpg"
                              alt="spotlight_img"
                            />
                          </div>
                          <div class="jp_spotlight_slider_cont_Wrapper">
                            ...
                            <ul>
                              <li>
                                <i class="fa fa-cc-paypal"></i>&nbsp; $12K - 15k
                                P.A.
                              </li>
                              <li>
                                <i class="fa fa-map-marker"></i>&nbsp;
                  ...
                  <div class="jp_rightside_job_categories_wrapper">
                    ...
                    <div class="jp_rightside_job_categories_content">
                      <ul>
                        ...
                        <li>
                          <i class="fa fa-caret-right"></i>
                          <a href="#">R&D Jobs <span>(554)</span></a>
                        </li>
                        <li>
                          <i class="fa fa-caret-right"></i>
                          <a href="#">Government Jobs <span>(350)</span></a>
                        </li>
                        <li>
                          <i class="fa fa-caret-right"></i>
                          <a href="#">PSU Jobs <span>(221)</span></a>
                        </li>
                        <li>
                  ...
                  <div class="jp_rightside_career_wrapper">
                    ...
                    <div class="jp_rightside_career_main_content">
                      ...
                      <div class="jp_rightside_career_btn">
                        <a href="#"
                          ><i class="fa fa-plus-circle"></i> View All</a
                        >
                      </div>
                    </div>
                  </div>
    ...
    <div class="jp_best_deals_main_wrapper">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div
              class="jp_rightside_career_wrapper jp_best_deal_right_sec_wrapper"
            >
              <div class="jp_rightside_career_heading">
              ...
              <div class="jp_rightside_career_main_content">
                ...
                >
                  ...
                  <div class="jp_rightside_career_img_cont">
                    ...
                    <p>
                      <i class="fa fa-folder-open-o"></i> &nbsp;Web Designer
                    </p>
                  </div>
                </div>
                <div class="jp_rightside_career_btn">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="jp_first_client_slider_wrapper">
              ...
              <div class="jp_client_slider_wrapper">
                <div class="~/assets/css/images/-carousel ~/assets/css/images/-theme">
                  <div class="item">
                    <div class="jp_client_slide_show_wrapper">
                      <div class="jp_client_slider_img_wrapper">
                        <img
                          src="~/assets/css/images/content/client_slider_img.jpg"
                          alt="client_img"
                        />
                      </div>
                      <div class="jp_client_slider_cont_wrapper">
                        ...
                        ><span>~ Jeniffer Doe &nbsp;<b>(Ui Designer)</b></span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="pricing_box1_wrapper pricing_border_box1_wrapper">
              ...
              <div class="pricing_cont_wrapper">
                <div class="pricing_cont">
                  <ul>
                    <li>
                      <i class="fa fa-plus-circle"></i> &nbsp;&nbsp;5 Jobs
                      Posting
                    </li>
                    <li>
                      <i class="fa fa-plus-circle"></i> &nbsp;&nbsp;2 Featured
                      jobs
                    </li>
                    <li>
                      <i class="fa fa-plus-circle"></i> &nbsp;&nbsp;1 Renew Jobs
                    </li>
                    <li>
                      <i class="fa fa-plus-circle"></i> &nbsp;&nbsp;10 Days
                      Duration
                    </li>
                    <li>
                      <i class="fa fa-plus-circle"></i> &nbsp;&nbsp;Email Alert
                    </li>
                  </ul>
                </div>
              </div>
              <div class="pricing_btn_wrapper">
                <div class="pricing_btn1">
                  <ul>
                    <li>
                      <a href="#"
                        ><i class="fa fa-plus-circle"></i> Get Started</a
                      >
                    </li>
                  </ul>
                </div>
    ...
    <div class="jp_downlord_main_wrapper">
      ...
      <div class="container">
        <div class="row">
          <div
            class="col-lg-6 col-md-6 col-sm-12 col-xs-12 hidden-sm hidden-xs"
          >
            <div class="jp_down_mob_img_wrapper">
              <img
                src="~/assets/css/images/content/mobail.png"
                alt="mobail_img"
              />
            </div>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="ss_download_wrapper_details">
              ...
              <p>
                Fast, Simple & Delightful. All it takes is 30 seconds to
                Download.
              </p>
              <a href="#" class="ss_appstore"
                ><span><i class="fa fa-apple" aria-hidden="true"></i></span> App
                Store</a
              >
          ...
          <div
            class="col-lg-6 col-md-6 col-sm-12 col-xs-12 visible-sm visible-xs"
          >
            <div class="jp_down_mob_img_wrapper">
              <img
                src="~/assets/css/images/content/mobail.png"
